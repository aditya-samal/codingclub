// File: app/page.js (Step 1 Login Page with Dark Theme)
"use client";
...
export default function Step1Login() {
  ...
  // Step 1 requirements - More challenging but still reasonable
  const [step1Requirements, setStep1Requirements] = useState([
  ...
  const handleSubmit = (e) => {
    ...
    if (step1Requirements.every(req => req.fulfilled)) {
      // Store username and password in sessionStorage to pass to next step
            ...
            <div>
              ...
              <div className="mt-3 space-y-2">
                <div className="flex justify-between text-xs font-medium">
                  <span className={`${getPasswordStrengthPercentage() < 30 ? 'text-red-400' : 
